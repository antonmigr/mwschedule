...
function AgendaView(element, calendar, viewName) {
	...
	function slotBind(cells) {
	    ...
	    cells.click(slotClick)
			.mousedown(slotSelectionMousedown).mouseover(slotSelectionMouseover);
		//cells.hover(slotClick).hover(slotSelectionMousedown);
	}
	...
	var tt = 1;
	//$('#calendar').onclick = function () { prompt('down'); }
	        ...
	        if (ev.which == 1 && opt('selectable')) { // ev.which==1 means left mouse button
	            ...
	            hoverListener.start(function (cell, origCell) {
	                ...
	                if (cell && cell.col == origCell.col && !getIsCellAllDay(cell)) {
	                    ...
	                    d2.add(60, 'minutes'); //SCHEDULE2.PHP
	                    dates = [
                            d1,
                            d1.clone().add(snapDuration), // calculate minutes depending on selection slot minutes
                            d2,
                            d2.clone().add(snapDuration)//d2.clone().add(snapDuration)
	                    ].sort(dateCompare);
	                    globalStart = dates[0];
	                    globalEnd = dates[3];
	...
	var timeClicked=null;
	var retButton = function () { return this.overOrDown; };
	function slotSelectionMouseover(ev) {
	  ...
	  //  alreadySelected = false;
	    ...
	    //if (1 == 1) {//if (ev.which == 1 && opt('selectable')) { // ev.which==1 means left mouse button
	    if(opt('selectable')) {
	        unselect(ev);
	        var dates;
	        hoverListener.start(function (cell, origCell) {
	            ...
	            if (cell && cell.col == origCell.col && !getIsCellAllDay(cell)) {
	                ...
	                renderSlotOverlay(dates[0], dates[3]);
	          //     renderSlotSelection(dates[0], dates[3]);
	        ...
	        $(document).one('mouseup', function (ev) {
                     hoverListener.stop();
	                            ...
	                            //        reportDayClick(dates[0], ev);
	                                ...
	                                // prompt('select');
	                             //   renderSlotOverlay(dates[0], dates[3]);//reportSelection(dates[0], dates[3], ev);
